...
import { HireModel } from "src/app/admin/jobApplication/model/index";
import { InterviewModel, SelectListItemModel } from "src/app/shared/models";
import { DepartmentService, DesignationService } from 'src/app/admin/services';
import { CandidateService } from "src/app/admin/services";

@Component({
    selector: 'app-hire-interview',
    templateUrl: './upsert-hire.component.html',
})
export class UpsertHireComponent implements OnInit {
