...
namespace Hrms.Api.Controllers
{
    ...
    public class DesignationController : ControllerBase
    {
        ...
        {
            if (await _manager.IsDesignationExistAsync(model.Name))
            {
                return BadRequest("Designation already exist");
            }
            try
            {
            ...
            {
                _logger.LogError(ex, "Add Designation");
                return BadRequest(ex.Message);
            }
        }

        [HttpGet("{id}")]
        [ProducesResponseType(typeof(DesignationModel), StatusCodes.Status200OK)]
        ...
        [HttpGet("page-list")]
        [ProducesResponseType(typeof(MatTableResponse<DesignationModel>), StatusCodes.Status200OK)]
