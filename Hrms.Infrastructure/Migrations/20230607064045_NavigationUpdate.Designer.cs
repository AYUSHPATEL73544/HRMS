...
namespace Hrms.Infrastructure.Migrations
{
    ...
    [Migration("20230607064045_NavigationUpdate")]
    partial class NavigationUpdate
    {
            ...
            modelBuilder.Entity("Hrms.Core.Entities.Family", b =>
                {
                    ...
                    b.HasOne("Hrms.Core.Entities.Relationship", null)
                        .WithOne("Member")
                        .HasForeignKey("Hrms.Core.Entities.Family", "RelationshipId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
