...
namespace Hrms.Infrastructure.Migrations
{
    ...
    [Migration("20231227051346_UpdateReimbursement2")]
    partial class UpdateReimbursement2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hrms.Core.Entities.ApplicantsSkill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hrms.Core.Entities.Document", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hrms.Core.Entities.Interview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool?>("EligibleForNextRound")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("Hrms.Core.Entities.JobApplication", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hrms.Core.Entities.Note", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hrms.Core.Entities.Reimbursement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hrms.Core.Entities.Skill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hrms.Core.Entities.ApplicantsSkill", b =>
                {
                    b.HasOne("Hrms.Core.Entities.JobApplication", null)
                        .WithMany("ApplicantsSkills")
                        .HasForeignKey("ApplicantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Hrms.Core.Entities.Skill", "Skill")
                        .WithMany()
            ...
            modelBuilder.Entity("Hrms.Core.Entities.AttendanceRule", b =>
                {
                    b.HasOne("Hrms.Core.Entities.Company", null)
            ...
            modelBuilder.Entity("Hrms.Core.Entities.Education", b =>
                {
                    b.HasOne("Hrms.Core.Entities.CourseType", null)
                        .WithMany("Educations")
                    ...
                    b.HasOne("Hrms.Core.Entities.QualificationType", null)
                        .WithMany("Educations")
            ...
            modelBuilder.Entity("Hrms.Core.Entities.Employee", b =>
                {
                    ...
                    b.HasOne("Hrms.Core.Entities.User", null)
                        .WithOne("Employee")
                        .HasForeignKey("Hrms.Core.Entities.Employee", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Hrms.Core.Entities.Family", b =>
                {
                    ...
                    b.HasOne("Hrms.Core.Entities.Relationship", "Relationship")
                        .WithMany()
            ...
            modelBuilder.Entity("Hrms.Core.Entities.Interview", b =>
                {
                    ...
                    b.HasOne("Hrms.Core.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Hrms.Core.Entities.Leave", b =>
                {
                    ...
                    b.HasOne("Hrms.Core.Entities.LeaveRule", null)
                        .WithMany("Leaves")
            ...
            modelBuilder.Entity("Hrms.Core.Entities.Manufacturer", b =>
                {
                    b.HasOne("Hrms.Core.Entities.AssetType", null)
            ...
            modelBuilder.Entity("Hrms.Core.Entities.Variant", b =>
                {
                    b.HasOne("Hrms.Core.Entities.Manufacturer", null)
                        .WithMany("Variants")
                        .HasForeignKey("ManufacturerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
